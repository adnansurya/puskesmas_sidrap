...
<div class="row jumbotron m-0">
    <div class="d-flex justify-content-center align-items-center">
        <div class="col-lg-6">
            ...
            <p class="text-white text-center mt-5">Website ini merupakan sebuah implementasi dari sistem digitalisasi puskesmas kawasan Tanrutedong (Sidenreng Rappang). Dengan adanya website ini, diharapkan sistem kerja di puskesmas dapat terleksana dengan lebih baik, cepat dan efisien.</p>
